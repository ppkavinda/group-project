        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="{{url('/admin/edit-course') }}" name="add_course" id="add_course" enctype="multipart/form-data" >{{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="course_sub_title" id="course_subtitle" placeholder="Enter Course Sub title " required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" name="cover_img" id="cover_img" name=""class="form-control" required>
