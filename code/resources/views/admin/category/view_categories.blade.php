             ...
             <table class="table table-bordered">
                <thead>
                  ...
                  <tr>
                    ...
                    <td class="left">
                    <span><a href="{{ url('admin/edit-category/'.$category->id)}}" class="btn btn-primary btn mini">Edit</a>
                    <a href="{{ url('admin/delete-category/'.$category->id)}}"class="btn btn-primary btn mini">Delete</a></span>
