...
<!-- //header-bot main-header navbar navbar-expand bg-white navbar-light border-bottom-->
<!-- banner -->
<div class="ban-top">
	<div class="container">
		<div class="top_nav_left">
			<nav class="navbar navbar-expand-lg navbar-default navbar-dark py-0 pb-0 border-bottom">
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  ...
				  <ul class="navbar-nav menu__list mr-auto">
                    ...
                    <a class="nav-link menu__link" data-widget="pushmenu" href="#"><i class="fa fa-bars"></i> Menu<span class="sr-only">(current)</span></a>
                    </li>
