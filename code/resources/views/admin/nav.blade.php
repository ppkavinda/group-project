...
<div class="ban-top">
	<div class="container">
		<div class="top_nav_left">
			<nav class="navbar navbar-expand-lg navbar-default navbar-dark py-6 pb-6">
			  <div class="container-fluid"> 
				<!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header">
				  <button type="button" class="navbar-toggler mt-6" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" 
        		...
        		<a class="nav-link" data-widget="pushmenu" href="#"><i class="fa fa-bars"></i></a>
				  		...
				  		<li class="nav-item menu__item {{ Request::is('/') ? 'menu__item--current' : '' }}">
							<a class="nav-link menu__link" href="/">   <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item menu__item {{ Request::is('/') ? 'menu__item--current' : '' }}">
