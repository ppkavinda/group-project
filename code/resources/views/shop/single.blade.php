                ...
                <div class="grid images_3_of_2">
                    <div class="flexslider">
                        <div class="flex-viewport" style="overflow: hidden; position: relative;">
                            <ul class="slides" style="width: 1000%; transition-duration: 0.6s; transform: translate3d(-680px, 0px, 0px);">
                                <li data-thumb="images/d3.jpg" class="clone" aria-hidden="true" style="width: 340px; float: left; display: block;">
                                    <div class="thumb-image">
                                        <img src="images/d3.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> 
                                    </div>
                                </li>
                                <li data-thumb="images/d2.jpg" style="width: 340px; float: left; display: block;" class="">
                                    <div class="thumb-image"> 
                                        <img src="images/d2.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> 
                                    </div>
                                </li>
                                <li data-thumb="images/d1.jpg" class="flex-active-slide" style="width: 340px; float: left; display: block;">
                                    <div class="thumb-image"> 
                                        <img src="images/d1.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> 
                                    </div>
                                </li>	
                                <li data-thumb="images/d3.jpg" style="width: 340px; float: left; display: block;">
                                    <div class="thumb-image"> 
                                        <img src="images/d3.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> 
                                    </div>
                                </li>
                                <li data-thumb="images/d2.jpg" style="width: 340px; float: left; display: block;" class="clone" aria-hidden="true">
                                    <div class="thumb-image"> 
                                        <img src="images/d2.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> 
                                    </div>
                                </li>
                        ...
                        <ol class="flex-control-nav flex-control-thumbs">
                            <li><img src="images/d2.jpg" class="" draggable="false"></li>
                            <li><img src="images/d1.jpg" draggable="false" class="flex-active"></li>
                            <li><img src="images/d3.jpg" draggable="false"></li>
                        </ol>
