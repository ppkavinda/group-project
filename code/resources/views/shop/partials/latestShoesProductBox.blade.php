	...
	<div class="col-md-3 product-men">
		<div class="men-pro-item simpleCart_shelfItem">
			<div class="men-thumb-item">
				<img src="/storage/{{$latestShoes[$x]['img1']}}" alt="" class="pro-image-front img-fluid" style="width:200px; height:200px;">
				<img src="/storage/{{$latestShoes[$x]['img1']}}" alt="" class="pro-image-back img-fluid" style="width:200px; height:200px;">
