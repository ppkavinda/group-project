    ...
    <div class="login-logo">
      ...
      <form action="../../" method="post" action="{{route ('signup') }}">
        ...
        <div class="form-group has-feedback">
          ...
          <input type="text" class="form-control" placeholder="NIC Number" pattern="[0-9]{9}[vV]{1}$" title="Include 9 digits and letter V  eg:123456789V" required>
          </div>
        </div>
        ...
        <div class="form-group has-feedback">
          <div class="input-group">
            <div class="input-group-prepend">
              ...
              <input type="email" class="form-control" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$"  title ="" required>
          </div>
        </div>
