...
<div class="col-sm-11 container">
    <p>&emsp;&emsp;The National Vidatha Network (NVN) seeks to transfer scientific knowledge
    ...
    <br>
    <p>&emsp;&emsp;In order to implement this programme, the Ministry has established a Vidatha Resource Centre
    ...
    <br>
    <p>&emsp;&emsp;Technology Transfer programmes are identified based on the availability of
    ...
    <br>
    <p>&emsp;&emsp;Continuous focus is placed on improving the performance of VRCs and
