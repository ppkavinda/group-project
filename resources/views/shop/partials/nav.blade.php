...
<div class="ban-top">
	<div class="container">
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="navbar-nav menu__list">
							...
							<ul class="dropdown-menu multi-column columns-3" area-labelledby="navbarDropdown">
								<div class="agile_inner_drop_nav_info row">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="/dist/img/top2.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a ref="mens.html">Clothing</a></li>
											<li><a ref="mens.html">Wallets</a></li>
											<li><a ref="mens.html">Footwear</a></li>
											<li><a ref="mens.html">Watches</a></li>
											<li><a ref="mens.html">Accessories</a></li>
											<li><a ref="mens.html">Bags</a></li>
											<li><a ref="mens.html">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
					...
					<li class="nav-item dropdown menu__item">
						<a href="#" class="nav-link dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Women's wear
						<span class="fa fa-caret-down"></span>
						</a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info row">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="/dist/img/top1.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					...
					<li class="nav-item dropdown menu__item ">
					   <a class="nav-link dropdown-toggle menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Short Codes
						<span class="fa fa-caret-down"></span>
					   </a>
						<ul class="dropdown-menu agile_short_dropdown">
							<li><a class="dropdown-item" href="icons.html">Web Icons</a></li>
		...
		<div class="top_nav_right">
			<div class="wthreecartaits wthreecartaits2 cart cart box_1" title="Go to Learning center"> 
